...
covariates <- covariates%>%
  mutate(status= 
           if_else(sample%in%c('5.02','5.03','5.07','5.08','5.11','5.13','6.01','6.02','6.03','6.04','6.05',
                              ...
                              '10.04','10.07','10.08', '10.12', '10.13', '10.14', '10.15', '14.02', '14.12', 
                              '14.13'),"NT","F"))
...
covariates <- covariates%>%
  mutate(zone=
           if_else(sample%in%c("1.01", "1.02", "1.03", "1.04", "1.05", "1.06", "3.01", "3.02", "3.03", "3.04",
                               "3.05", "3.06", "4.01", "4.02", "4.03", "4.08", "4.11", "4.12"), "SC", ifelse(
                                 sample%in%c('5.02','5.03','5.07','5.08','5.11','5.13','6.01','6.02','6.03','6.04','6.05',
                                             '6.12','7.01','7.02','7.03','7.04','7.05','7.08','8.01','8.02','8.05','8.06',
                                             '8.07','8.12','9.01','9.02','9.05','9.06','9.07','9.08','10.01','10.02','10.03',
                                             '10.04','10.07','10.08'), "NP", ifelse(sample%in%c("11.01", "11.02", "11.03",
                                                                                                "11.04", "11.05", "11.06",
                                                                                                "12.02", "12.03", "12.04",
                                                                                                "12.04", "12.05", "12.05",
                                                                                                "12.11", "13.02", "13.03",
